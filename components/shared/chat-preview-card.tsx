...
export function ChatPreviewCard({ chat }: ChatPreviewCardProps) {
  return (
    <article className="rounded-2xl border border-stroke bg-white p-4 shadow-card transition duration-200 hover:-translate-y-0.5 hover:shadow-lift">
      ...
      <div className="mt-4 flex items-center justify-between gap-2 border-t border-stroke pt-4">
        ...
        <div className="flex items-center gap-2">
          ...
          <button className="inline-flex items-center gap-1 rounded-lg border border-stroke px-2.5 py-1.5 text-xs font-semibold text-ink transition hover:bg-surface-soft">
